...
public:
  ...
  // glBegin() .. void setAttribute4f(const GLuint loc, const float* floatPtr);
  // // this is called between glBegin() and glEnd().. void setAttribute4i(const
  // GLuint loc, const int* intPtr); // this is called between glBegin() and
  // glEnd().. void setAttributeMat4(const GLuint loc, const float* floatPtr); //
  // must not trust this func !!!!
